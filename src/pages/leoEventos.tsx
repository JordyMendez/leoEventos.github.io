      ...
      <div className="flex flex-col items-center mb-6 text-center">
        ...
        <div className="flex flex-wrap justify-center space-x-4 mt-4">
          <a
            ...
            target="_blank"
          >
            <Video className="h-6 w-6 text-pink-600 hover:text-white transition-colors" />
          </a>
          <a
            href="https://www.instagram.com/leos_eventos?igsh=MWNkeXQyNGpuM2Nvcg=="
            target="_blank"
          >
            <Instagram className="h-6 w-6 text-pink-500 hover:text-white transition-colors" />
          </a>
          <a href="https://www.facebook.com/share/16qfx6obB6/" target="_blank">
            <Globe className="h-6 w-6 text-blue-600 hover:text-white transition-colors" />
          </a>
          <a href="https://maps.app.goo.gl/L5TJ4xLwGuJefRxWA" target="_blank">
            <MapPin className="h-6 w-6 text-red-600 hover:text-white transition-colors" />
          </a>
        </div>
      </div>
